...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lift_label.setGeometry(QtCore.QRect(580, 0, 321, 101))
        font = QtGui.QFont()
        ...
        self.lift_image.setGeometry(QtCore.QRect(10, 180, 681, 521))
        self.lift_image.setStyleSheet("background-image: url(:/images/start.jpeg);")
    ...
    def receive(self):
        global capPin, deg, capSum, lastTime
    ...
    #RETURN CODE that reshows signals home form to show itself and hide this form
